...
const HomeCatSlider = () => {
  return (
    <>
      ...
      >
        <SwiperSlide>
          <div className="item text-center justify-center rounded-md flex flex-col bg-white border border-transparent transition-all duration-300 hover:border-[rgba(42,41,41,0.34)] hover:shadow-[0_0_15px_rgba(0,0,0,0.35)] cursor-pointer">
            <img
        ...
        <SwiperSlide>
          <div className="item text-center justify-center rounded-md flex flex-col bg-white border border-transparent transition-all duration-300 hover:border-black hover:shadow-[0_0_15px_rgba(0,0,0,0.35)] cursor-pointer">
            <img
        ...
        <SwiperSlide>
          <div className="item text-center justify-center rounded-md flex flex-col bg-white">
            <img
